...
public final class ParentIDFinder {
    ...
    /**
     * Find a non {@code null} ID on the given {@link Parent}. If the ID is {@code null} then
     * search up the graph to find a node with the given ID.
     * @param node
     *            The starting node.
     * @return The ID of this node or the ID of the parent if this is {@code null}, if this is also
     *         null then the parent's parent will
